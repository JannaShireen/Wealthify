...
class EditIncomeTransaction extends StatefulWidget {
  ...
  @override
  State<EditIncomeTransaction> createState() => _EditIncomeTransactionState();
}




class _EditIncomeTransactionState extends State<EditIncomeTransaction> {
